...
(* OASIS_START *)
(* DO NOT EDIT (digest: a2b47eea24b3e5a8abacdee66eb8720e) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   ["-docflags '-colorize-code -short-functors'"];
                 run_path = "."
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/cakeplus/mparser";
          bugreports = None;
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Support for PCRE-based regular expression parsers";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Support for RE-based regular expression parsers";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["MParser"; "MParser_Sig"; "MParser_Char_Stream"];
                      lib_pack = false;
                      lib_internal_modules = ["MParser_Utils"];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mparser";
                      lib_findlib_directory = None;
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "lib_MParser_PCRE";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "pcre", OASISExpr.EFlag "all"),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   {
                      lib_modules = ["MParser_PCRE"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "lib_MParser";
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EOr
                              (OASISExpr.EFlag "re", OASISExpr.EFlag "all"),
                             true)
                        ];
                      bs_install =
                        [
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("re.perl", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for MParser";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\028\195K;O\221V\170'&\133q+\242\166\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
