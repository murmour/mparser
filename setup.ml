...
(* OASIS_START *)
(* DO NOT EDIT (digest: d66f1e5b24fa38396024183c6aa3afa1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["Holger Arnold"];
          homepage = Some "https://bitbucket.org/cakeplus/mparser";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["MParser"; "CharStream"];
                      lib_pack = false;
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\132xW\131\233H*\029;\155\208\148n:\229\001";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
